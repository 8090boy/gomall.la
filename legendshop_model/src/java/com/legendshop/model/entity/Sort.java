 ...
 * 产品分类，第一级分类.
 */
public class Sort extends UploadFile implements NamedEntity {
	 ...
	 *
	 * @param navigationMenu the new navigation menu
	 */
	...
	/* (non-Javadoc)
	 * @see com.legendshop.model.entity.NamedEntity#getName()
	 */
