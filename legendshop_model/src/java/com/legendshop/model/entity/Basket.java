...
public class Basket implements BaseEntity {
    ...
    private Integer pointsSubtotal; //积分
	 ...
	 * 用于构造订单列表的产品内容
	 */
	public Basket(Long basketId, Double cash,Double carriage,Long prodId,String pic,Integer basketCount, String prodName,String attribute, int points,int pointsSubtotal ) {
