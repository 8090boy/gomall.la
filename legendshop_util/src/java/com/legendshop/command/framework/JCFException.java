...
public class JCFException extends Exception {
	...
	/**
	 * Instantiates a new jCF exception.
	 */
	public JCFException() {
		super();
	 ...
	 *            the exception msg
	 */
	public JCFException(String errorCode, String pExceptionMsg) {
		super(pExceptionMsg);
	 ...
	 *            the exception
	 */
	public JCFException(String errorCode, String pExceptionMsg, Throwable pException) {
		super(pExceptionMsg);
