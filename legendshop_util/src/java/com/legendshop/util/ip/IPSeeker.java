...
public class IPSeeker {
	...
	/**
	 * Gets the single instance of IPSeeker.
	 * 
	 * @return single instance of IPSeeker
	 */
	/**
	 * @return 单一实例
	 */
	...
	/**
	 * Gets the iP entries debug.
	 * 
	 * @param s
	 *            the s
	 * @return the iP entries debug
	 */
	/**
