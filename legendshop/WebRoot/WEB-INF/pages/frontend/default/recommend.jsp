...
<div class="recommond">
	...
	<table width="100%" cellpadding="0" cellspacing="15">
		<tr>
			<c:choose>
				<c:when
					test="${requestScope.commendProdList != null && fn:length(requestScope.commendProdList) > 0}">
					<c:forEach items="${requestScope.commendProdList}" var="prod"
						varStatus="status">
