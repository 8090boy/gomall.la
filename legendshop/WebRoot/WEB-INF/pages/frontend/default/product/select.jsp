...
.select a {
	border: 2px solid #FF6701;
	margin: 0px;
	background: url(/common/default/images/productselected.gif) no-repeat
		right bottom;
}
-->
</style>
...
<body>
	<form name="form">
		...
		<div id="result">
			<input name="color" type="text" id="color" size="15" /> <input
				name="size" type="text" id="size" size="15" /> <input name="other"
				type="text" id="other" size="15" />
		</div>
	</form>
