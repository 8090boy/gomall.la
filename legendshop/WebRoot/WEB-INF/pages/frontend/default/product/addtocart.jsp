...
<![endif]-->
<a onclick="showcart(1)"><img
	src="${pageContext.request.contextPath}/common/default/images/addtocart.jpg"
	title='<fmt:message key="add.tocart" />' /></a>
&nbsp;
<div id="facebox"
	style="position: absolute; z-index: 9999; top: 260px; left: 430px; display: none; overflow: hidden;">
	<div>
		<h2>
			<span id="can_AddToCart"><fmt:message key="add.tocart.seccess" /></span>
		</h2>
		<p>
 ...
 function showcart(show){
	...
	if(show == 0){
		...
		if(prodAttr.startWith("error")){
			alert('请选择：' + prodAttr.substring(5));
			return;
		}
		    			jQuery.ajax({
