...
<script type="text/javascript" language="javascript"
	src="${pageContext.request.contextPath}/common/js/randomimage.js"></script>
...
<c:forEach items="${requestScope.USER_REG_ADV_740}" var="adv">
	<table width="100%" cellspacing="0" cellpadding="0"
		style="margin-bottom: 4px; margin-right: 5px;" class="picstyle">
		<tr>
...
<table width="100%" class="tables" cellpadding="0" cellspacing="0">
	<tr>
		<td class="titlebg">
			<div align="center">
				<b><fmt:message key="leave.word" /> </b>
			</div>
		</td>
	</tr>
	<tr>
		<td>
			<form method="POST"
				action="${pageContext.request.contextPath}/userComment/save"
				id="form1" name="form1"
				onsubmit="return validateRandNum('${pageContext.request.contextPath}');">
				<input id="userId" name="userId"
					value="<%=UserManager.getUserId(request)%>" type="hidden" /> <input
				...
				<table>
					<tr>
						...
						<td>
							<div align="left">
								<p>
									<input type="text" id="yourName" name="yourName" size="30"
										maxlength="30">
								</p>
							</div>
						</td>
					...
					<tr>
						...
						<td><textarea rows="10" cols="50" id="content" name="content"></textarea>
					...
					<tr>
						...
						<input type="hidden" id="cannonull" name="cannonull"
							value="<fmt:message key="randomimage.errors.required"/>" />
						<input type="hidden" id="charactors4" name="charactors4"
							value="<ls:i18n key="randomimage.charactors.required" length="4"/>" />
						<input type="hidden" id="errorImage" name="errorImage"
							value="<fmt:message key="error.image.validation"/>" />
						<td align="left"><input type="text" id="randNum"
							name="randNum" class="inputbutton2" maxlength="7" size="7"
					...
					<tr>
						<td></td>
						<td align="left"><fmt:message key="change.random1" /> &nbsp;<a
							href="javascript:void(0)"
							onclick="javascript:changeRandImg('${pageContext.request.contextPath}')"
							style="font-weight: bold;"><fmt:message key="change.random2" /></a></td>
					</tr>
