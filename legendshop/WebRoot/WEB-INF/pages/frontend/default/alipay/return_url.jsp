...
<%@page
	import="com.legendshop.business.payment.alipay.util.AlipayNotify"%>
...
%>
	<table align="center" width="450" cellpadding="5" cellspacing="0">
		<tr>
			<td align="center" class="font_title" colspan="2">通知返回<a
				href="${DOMAIN_NAME}">[返回系统]</a></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="font_content" align="right">卖家姓名：</td>
