...
%>
<form action="${pageContext.request.contextPath}/addShop" method="post"
	name="openShopForm" id="openShopForm" enctype="multipart/form-data">
			...
			<td>
				<table width="100%">
					...
					<tr>
						...
						<td height="27"><div align="left">
								<input type="text" name="idCardNum" id="idCardNum" class="input"
									maxlength="20" />
							</div></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td height="27"><div align="left">
								<input type="file"
									style="FONT-SIZE: 12px; WIDTH: 250px; margin-left: 10px"
									name="idCardPicFile" id="trafficPicFile" class="input" />
							</div></td>
					</tr>
					<tr>
						<td colspan="2">
									...
									<tr>
										...
										<td>
											<div align="left">
												<input type="file"
													style="FONT-SIZE: 12px; WIDTH: 250px; margin-left: 10px;"
													name="trafficPicFile" id="trafficPicFile" class="input" />
											</div>
										</td>
									</tr>
								</table>
						...
						<tr>
							<td><div align="left" style="margin-left: 100px">
									<input type="submit" value="<fmt:message key="submit"/>"
										class="s" style="margin-left: 250px" /> <input type="reset"
