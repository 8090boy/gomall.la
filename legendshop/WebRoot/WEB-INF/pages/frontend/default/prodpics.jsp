...
<link rel="stylesheet" type="text/css" media='screen'
	href="${pageContext.request.contextPath}/common/default/css/productpics.css" />
<div class="jqzoom" id="spec-n1">
	<a href="<ls:photo item='${prod.pic}'/>" class="jqzoom" rel='gal1'
		title="${prod.name}"> <img width="350px" height="350px"
...
<c:if
					...
					<c:forEach items="${requestScope.prodPics}" var="pics">
						<div class="pic">
							<a
								...
								target="_blank"> <img
								src="<ls:images item='${pics.filePath}' scale='3'/>" width="65"
								height="50" /></a>
						</div>
					</c:forEach>
					<!-- 图片列表 end -->
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/common/default/js/productpics.js"></script>
</c:if>
<script type="text/javascript">
