...
<table width="960px" cellpadding="0" cellspacing="0"
	style="margin-bottom: 5px" class="tables">
	<tr>
		<td class="myaccount"><fmt:message key="order.processing" /></td>
		<td>${totalProcessingOrder}&nbsp;&nbsp;<a
			href="${pageContext.request.contextPath}/p/order">[<fmt:message
					key="Query.Order.Status" />]
		</a></td>
		<td class="myaccount"><fmt:message key="product.subscribed.list" /></a></td>
		<td>${totalBasketByuserName}&nbsp;&nbsp;<a
			href="${pageContext.request.contextPath}/p/buy">[<fmt:message
					key="shopingCar" />]
		</a></td>
		<td class="myaccount">
			<%
	...
	<tr>
		<td class="myaccount"><fmt:message key="register.date" /></td>
		<td><fmt:formatDate value="${user.userRegtime}"
				pattern="yyyy-MM-dd" /></td>
		<td class="myaccount"><fmt:message key="last.login.date" /></td>
		<td><fmt:formatDate value="${user.userLasttime}"
				pattern="yyyy-MM-dd" /></td>
		<td class="myaccount"><fmt:message key="last.login.ip" /></td>
				...
				<tr>
					<td align="left">
						<form action="${pageContext.request.contextPath}/updateAccount"
							method="post" name="userUpdateForm" id="userUpdateForm">
							<input type="hidden" id="userId" name="userId"
								value="${user.userId}">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<UL>
								<fmt:message key="register.hint" />
							</UL>
							<br>
							<table width="100%" align="center" cellpadding="0"
								cellspacing="0" style="margin-bottom: 6">
								<tr>
									...
									<td width="67%"><div align="left">
											<c:choose>
												<c:when test="${param.userName == null}">
													<input style="WIDTH: 200px; color: #949492" type="text"
														name="userName" id="userName" size="20" class=input
												...
												<c:otherwise>
													<auth:auth ifAnyGranted="F_VIEW_ALL_DATA">
														<input style="WIDTH: 200px; color: #949492" type="text"
															name="userName" id="userName" size="20" class=input
															value="${param.userName}" readonly="readonly">
													</auth:auth>
                                 ...
                                 &nbsp; 
                                  <c:choose>
													<c:when test="${requestScope.myShopDetail == null}">
														<fmt:message key="shop.not.open" />
														<font style="font-weight: bold; color: #CCFFCC"><a
															href="${pageContext.request.contextPath}/openShop"><fmt:message
																	key="apply.hint" /></a></font>?
                                  	</c:when>
													<c:otherwise>
														...
														<c:if test="${requestScope.myShopDetail.status == -2}">
															<fmt:message key="shop.audit.failed" />
															<a href="${pageContext.request.contextPath}/openShop"><b><fmt:message
																		key="review.material" /></b></a>
														</c:if>
														<c:if test="${requestScope.myShopDetail.status == 1}">
															<a href="<ls:url address='/admin/index'/>"><b><fmt:message
																		key="fill.detail.shop" /></b></a>
														</c:if>
													</c:otherwise>
												</c:choose>
											</c:if>
								...
								<tr>
									...
									<td height="29"><div align="left">
											<auth:auth ifAnyGranted="F_VIEW_ALL_DATA">
												<input style="WIDTH: 200px;" type="text" name="userMail"
													id="userMail" size="20" class=input
													value="${user.userMail}" />
											</auth:auth>
											<auth:auth ifNotGranted="F_VIEW_ALL_DATA">
												<input style="WIDTH: 200px; color: #949492" type="text"
													name="userMail" id="userMail" size="20" class=input
													value="${user.userMail}" readonly="readonly" />
											</auth:auth>
											&nbsp;
											<fmt:message key="mail.canot.changed" />
										</div></td>
								</tr>
								<tr>
									<td height="29"><div align="right">
											<font color="#ff0000">*</font>
											<fmt:message key="real.name" />
											：
										</div></td>
									<td height="29"><div align="left">
											<input style="WIDTH: 200px" type="text" name="nickName"
												id="nickName" size="20" class=input value="${user.nickName}"
												maxlength="30">
										</div></td>
								</tr>
								<tr>
									...
									<td height="29"><div align="left">
											<input style="WIDTH: 200px" type="text" name="userMobile"
												id="userMobile" size="20" class=input
												value="${user.userMobile}" maxlength="50">
										</div></td>
								</tr>
								<tr>
									<td height="29"><div align="right">
											<fmt:message key="userTel" />
											：
										</div></td>
									<td height="29"><div align="left">
											<input style="WIDTH: 200px" type="text" name="userTel"
												id="userTel" size="20" class=input value="${user.userTel}"
												maxlength="50">
										</div></td>
								</tr>
								<tr>
									...
									<td height="29"><div align="left">
											<input style="WIDTH: 200px" type="text" name="qq" id="qq"
												size="20" class=input value="${user.qq}" maxlength="50">&nbsp;
											<fmt:message key="more.qq.number" />
										</div></td>
								</tr>
								<tr>
									<td height="29"><div align="right">MSN：</div></td>
									<td height="29"><div align="left">
											<input style="WIDTH: 200px" type="text" name="msn" id="msn"
												size="20" class=input value="${user.msn}" maxlength="100">
										</div></td>
								</tr>
								<tr>
									<td height="29"><div align="right">
									...
									<td height="29"><div align="left">
											<input style="WIDTH: 200px" type="text" name="fax" id="fax"
												size="20" class=input value="${user.fax}" maxlength="15">
										</div></td>
								</tr>
								<tr>
									<td height="29"><div align="right">
									...
									<td height="29"><div align="left">
											<input style="WIDTH: 200px" type="text" name="userPostcode"
												id="userPostcode" size="20" class=input
												value="${user.userPostcode}" maxlength="15">
										</div></td>
								</tr>
								<tr>
									<td height="29"><div align="right">
											<fmt:message key="gender.hint" />
											：
										</div></td>
									<td height="29"><div align="left">
								...
								<tr>
									<td height="29"><div align="right">
											<fmt:message key="birth.day" />
											：
										</div></td>
									<td height="29"><div align="left">
											<select name="userBirthYear" id="userBirthYear" size="1"
												onchange="showmonth();showday()">
												<script>
										...
										document.write ("<option value="+i+">"+i+"</option>")
											...
											</select> <select name="userBirthMonth" id="userBirthMonth" size="1"
												onchange="showday();">
												<option value="">
													<fmt:message key="month.hint" />
												</option>
											</select> <select name="userBirthDay" id="userBirthDay" size="1">
												<option value="">
								...
								<tr>
									...
									<td height="29"><div align="left">
											<input style="WIDTH: 250px" type="text" name="userAdds"
												id="userAdds" size="20" class=input value="${user.userAdds}"
												maxlength="150">
										</div></td>
								</tr>
								<tr>
									<td height="29"><div align="right">
											<fmt:message key="modify.password" />
											：
										</div></td>

									<!--  修改密码 -->
									<td height="29"><div align="left">
											<input type="checkbox" name="modifyPass" id="modifyPass"
												onclick="javascript:changePass(this)">
										</div></td>
								</tr>
								<tr>
										...
										<div id="pass1" style="display: none">
											<table width="100%" cellpadding="0" cellspacing="0">
												...
												<tr>
													...
													<td height="29"><div align="left">
															<input style="WIDTH: 200px" type="password"
																name="password" id="password" size="20" class="input" />
														</div></td>
												</tr>
												<tr>
													<td height="29"><div align="right">
													...
													<td height="29"><div align="left">
															<input style="WIDTH: 200px" type="password"
																name="password2" id="password2" size="20" class="input" />
														</div></td>
												</tr>
											</table>
										</div>
												...
												<tr>
													<td><div align="center">
															...
															<input type="submit" value="<fmt:message key="submit"/>"
																class="s" /> <input type="reset"
																value="<fmt:message key="cancel"/>" class="s">
														</div></td>
...
<c:forEach items="${requestScope.USER_REG_ADV_740}" var="adv">
	<table width="960px" cellpadding="0" cellspacing="0"
		style="margin-bottom: 5px" class="picstyle">
		<tr>
			<td><a href="${adv.linkUrl}"><img
					src="<ls:photo item='${adv.picUrl}'/>" title="${adv.title}" /></a></td>
		</tr>
	</table>
</c:forEach>
<script type="text/javascript">
