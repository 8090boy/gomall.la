...
<body>
	...
	<table class="tables" id="resetpass" cellpadding="0" cellspacing="0">
		<tr height="25px">
			<td colspan="2" class="titlebg"><div
					style="font-size: 16px; font-weight: bold;">
					<fmt:message key="find.my.password" />
				</div>
				<br></td>
			</td>
		</tr>
		<tr height="25px">
			...
			<td><input type="text" maxlength="50" id="userName"
				name="userName" /></td>
		</tr>
		<tr height="25px">
			<td><fmt:message key="user.email" />：</td>
			<td><input type="text" maxlength="50" id="userMail"
				name="userMail" /></td>
		</tr>
		<tr height="25px">
			<td><fmt:message key="validation.code" />：</td>
			<td><input type="text" id="randNum" name="randNum"
				class="inputbutton2" maxlength="50" tabindex="3"></td>
		</tr>
		<tr height="25px">
			<td></td>
			<td><img id="randImage" name="randImage"
				src="<ls:templateResource item='/captcha.svl'/>" /> &nbsp;<a
		...
		<tr height="25px">
			<td colspan="2" align="center"><input type="submit"
				value='<fmt:message key="submit"/>' onclick="reset()" /></td>
		</tr>
	</table>
	<table id="sendMail" style="display: none">
		<tr>
			<td><br>
			<br>
			<fmt:message key="reset.mail.sended" /></td>
		</tr>
	</table>
</body>
</html>
