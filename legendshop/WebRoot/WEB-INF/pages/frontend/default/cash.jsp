...
<c:if test="${sessionScope.SPRING_SECURITY_LAST_USERNAME != null}">
	<form action="${pageContext.request.contextPath}/sub/save"
		method="post" id="cashSaveForm" name="cashSaveForm">
		<table style="margin-top: 5px" class="tables" width="100%">
			<tr>
			...
			<tr>
				<td><jsp:include flush="true" page="/p/cashsave"></jsp:include></td>
			</tr>
		</table>
	</form>
</c:if>