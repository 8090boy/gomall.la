...
<table width="205px" cellspacing="0" cellpadding="0"
	style="margin-bottom: 4px; margin-left: 4px;" class="tables">
	<tr>
		<td class="titlebg" valign="middle" width="200px"><fmt:message
				key="new.product" /></td>
	</tr>
						...
						<tr align="left" valign="top">
							<c:choose>
								<c:when test="${fn:length(prod.name) > 14}">
									<td valign="middle" width="12px"><img
									...
									<td title="${prod.name}" align="left">
										<div class="topnewsfixed">
											<font color="#006699"> <a
												...
												style="margin-left: 3px;">${prod.name}</a>
											</font>
										</div>
									</td>
								</c:when>
