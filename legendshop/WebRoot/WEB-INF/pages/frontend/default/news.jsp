	...
	<tr>
		<td>
			<div style="margin: 8px;" align="right">
				<form action="${pageContext.request.contextPath}/allnews" id="form1"
					method="post">
					<span style="margin-right: 20px"><fmt:formatDate
							value="${news.newsDate}" pattern="yyyy-MM-dd" /></span>
					...
					： <select id="newsCategoryId" name="newsCategoryId"
						...
						<ls:optionGroup type="select" required="true" cache="fasle"
							...
							param="${news.userName}" selectedValue="${newsCategoryId}" />
