...
<link
	href="${pageContext.request.contextPath}/common/default/css/header.css"
					...
					<div id="site-nav">
						<ul class="quick-menu">
							...
							<li><ls:i18n key="nows.location" /> <c:if
									...
									href="${pageContext.request.contextPath}/shopcontact"><lb:currentShop /></a>
							</b></li>
							<% } %>
							<c:if test="${'C2C' == applicationScope.BUSINESS_MODE}">
								<li><a
									href="${pageContext.request.contextPath}/reg?openshop=1"
								...
								<div class="menu">
									...
									<div class="menu-bd"
										...
										<div class="menu-bd-panel">
											...
											<c:forEach items="${requestScope.navigationList}"
												var="navigation" end="4">
												<dl>
													<dt>
														<b>${navigation.name}</b>
														<dd>
