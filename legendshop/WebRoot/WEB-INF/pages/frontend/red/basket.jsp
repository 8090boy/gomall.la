...
<title>用户中心</title>
<link type="text/css" href="../css/legend.css" rel="stylesheet" />
...
<body>
	...
	<div id="shortcut">
		<div class="w">
			<ul class="fl lh">
				<li class="fore1"><a target="_blank" href="#">&lt;&lt;返回商城</a></li>
			</ul>
			<ul class="fr lh">
				<li id="loginbar" class="ld">欢迎来到LengedShop！<span><a
						href="#">[登录]</a> <a class="link-regist" href="#">[免费注册]</a></span></li>
				<li><a href="#">我的订单</a></li>
				<li class="menu">
					<dl>
						<dt class="ld">
	...
	<div id="logo" class="w">
		...
		<p class="logopic">
			<img src="../images/logo.png" width="257" height="42" />
		</p>

		<div class="searchwrap">
			<div class="search">
				<div class="sleft">
					<select><option>商品</option>
						<option>商场</option></select>
				</div>
				<input type="text" />
			</div>
			<p class="searchpic">
				<a href="#"><img src="../images/search.gif" width="104"
					height="40" /></a>
			</p>
			<div class="clear"></div>
		...
		<p class="shoplist">
			<img src="../images/geren.gif" width="142" height="46" /> &nbsp; <img
				src="../images/shoplist.gif" width="156" height="47" />
		</p>
								...
								<dl class="fore9">
									...
									<dd>
										<em><a href="#">科技</a></em><em><a href="#">工程</a></em><em><a
											href="#">建筑</a></em><em><a href="#">医学</a></em><em><a
											href="#">科学/自然</a></em><em><a href="#">计算机/互联网</a></em><em><a
											href="#">体育/运动</a></em>
									</dd>
								</dl>
								<dl class="fore10">
					...
					<tbody>
						...
						<tr>
							<td style="height: 30px" colspan="6" class="Tfoot">重量总计：0.00kg&nbsp;&nbsp;&nbsp;原始金额：￥0.00元
								- 返现：￥0.00元<br><span style="font-size: 14px"><b>商品总金额：<span
			...
			<div class="List_cart marginb10" style="margin-left: 150px;">
				...
				<div class="cart_table">
									...
									<ul>
												...
												<tbody>
													<tr>
														<td style="width: 20px;"><input type="radio"
															onclick="changeConsignee(this,'3265226');"
															name="rbtnAddr" addresstype="1" id="addr_3265226"></td>
										...
										<li id="addrIi3265261"><table cellspacing="0"
												...
												<tbody>
													<tr>
														<td style="width: 20px;"><input type="radio"
															onclick="changeConsignee(this,'3265261');"
															name="rbtnAddr" addresstype="1" id="addr_3265261"></td>
										...
										<li id="addrIi7689310"><table cellspacing="0"
												...
												<tbody>
													<tr>
														<td style="width: 20px;"><input type="radio"
															onclick="changeConsignee(this,'7689310');"
															name="rbtnAddr" addresstype="1" id="addr_7689310"></td>
									...
									<tbody>
										...
										<tr>
											...
											<td align="left" valign="middle"><input type="text"
												...
												id="consignee_email"> &nbsp;<font color="#000000">用来接收订单提醒邮件，便于您及时了解订单状态</font></td>
										</tr>
					...
					<div id="part_payTypeAndShipType">
						<div class="o_write">
									...
									<tbody>
										<tr>
											<td align="left" valign="top" style="width: 240px"><input
												...
												onclick="changePayType(1);" id="IdPaymentType1"
												name="IdPaymentType"><label for="IdPaymentType1"
													style="margin-left: 2px;">货到付款 </label></td>
											<td valign="top" class="gray">送货上门后再收款，支持现金、POS机刷卡、支票支付
												<a href="http://www.360buy.com/help/cod.aspx"
												target="_blank">查看运费及配送范围</a>
											</td>
										</tr>
									</tbody>
								</table>
										...
										<tr>
											<td align="left" valign="top" style="width: 240px"><input
												...
												id="IdPaymentType4" name="IdPaymentType"><label
													for="IdPaymentType4" style="margin-left: 2px;">在线支付
												</label></td>
										...
										<tr>
											<td align="left" valign="top" style="width: 240px"><input
												...
												id="IdPaymentType5" name="IdPaymentType"><label
													for="IdPaymentType5" style="margin-left: 2px;">公司转账
												</label></td>
										...
										<tr>
											<td align="left" valign="top" style="width: 240px"><input
												...
												id="IdPaymentType2" name="IdPaymentType"><label
													for="IdPaymentType2" style="margin-left: 2px;">邮局汇款
												</label></td>
							...
							<div style="margin-top: 8px; display:" id="part_shipType"
								...
								<table align="enter" width="100%" cellspacing="0"
									cellpadding="0" border="0" id="ShipMentTab">
									<tbody>
										<tr>
								...
								<div style="display:" id="CodTimeUpdatePanel">
									<div
										style="margin-left: 40px; width: 648px; padding-left: 4px;"
										class="tsbox">
										...
										<div>
											<table>
												<tbody>
													<tr>
														<td valign="top" style="width: 70px">&nbsp;送货日期：<br>&nbsp;大件商品</td>
										...
										<div>
											付款方式： <input type="radio" checked=""
												onclick="g('payType_PaymentWay').value=this.value;"
												value="0" id="PaymentWay0" name="PaymentWay"><label
												for="PaymentWay0" style="margin-left: 2px;">现金</label> <input
												type="radio"
												onclick="g('payType_PaymentWay').value=this.value;"
												value="1" id="PaymentWay1" name="PaymentWay"><label
													for="PaymentWay1" style="margin-left: 2px;">POS刷卡</label> <input
													type="radio"
													onclick="g('payType_PaymentWay').value=this.value;"
													value="2" id="PaymentWay2" name="PaymentWay"><label
							...
							<div style="display: none">
								<input type="text" value="1" id="payType_IdPaymentType">
									<input type="text" value="70" id="payType_IdShipmentType">
										<input type="text" value="0" id="payType_IdPickSite">
											<input type="text" value="2" id="payType_CODTime"> <input
												type="text" value="0" id="payType_PaymentWay"> <input
													type="text" value="" id="payType_IdAgent"> <input
														type="text" value="False" id="payType_IsCodInform">
															<input type="text" value="0" id="payType_ShipTime">
																<input type="text" value="0" id="payType_BigItemCodTime">
																	<input type="text" value="" id="payType_SubWayName">
							</div>

							<div class="footer">
								<input type="button" onclick="savePayTypeAndShipType(this)"
									value="保存支付方式及配送方式"
									clstag="checkout|keycount|jiesuan|savezhifu" class="btn">
							</div>
						</div>
					</div>
					<!--支付方式及配送方式结束-->
					...
					<div class="o_write">
						...
						<div style="display:" class="middle" id="invoiceFormPanel">
							...
							<div id="part_invoice_form">
											...
											<tr>
												<td align="left" valign="top" colspan="2"><span
													...
													id="invoince_InvoiceType1" name="invoince_type"><label
														for="invoince_InvoiceType1">普通发票</label> <input
														type="radio" value="2" onclick="invoince_setType(2)"
											...
											<tr>
												<td align="left" valign="top" colspan="2"><span
													...
													id="invoince_pttt4" name="invoince_pttt"><label
														...
														value="5" onclick="invoince_setPttt(5)"
														id="invoince_pttt5" name="invoince_pttt"><label
															for="invoince_pttt5">单位</label></td>
											</tr>
											...
											<tr style="display: none;" id="invoice_unitNameTr"
												...
												<td align="left" valign="top"><input type="text"
													...
													class="txt" id="invoice_Unit_TitName"><span
														class="red2">*</span><br><span class="gray">温馨提示：您填写的所有内容都将被系统自动打印到发票上，所以请千万别填写和发票抬头无关的信息。</span></td>
											</tr>
										</tbody>
														...
														<tbody>
															...
															<tr>
																...
																<td align="left" width="583" valign="top"><input
																	...
																	id="invoice_Ivc_TitName"><span class="red2">*</span></td>
															</tr>
															<tr>
															...
															<tr>
																...
																<td align="left" valign="top"><input type="text"
																	...
																	style="width: 260px" class="txt"
																	id="invoice_Ivc_Address"><span class="red2">*</span></td>
															</tr>
															<tr>
															...
															<tr>
																...
																<td align="left" valign="top"><input type="text"
																	...
																	style="width: 260px" class="txt"
																	id="invoice_Ivc_BankCode"><span class="red2">*</span></td>
															</tr>

															<tr>
																<td align="left" valign="top">&nbsp;</td>
																<td align="left" valign="top">
																	首次开具增值税专用发票的客户需提供加盖公章的营业执照副本、税务登记证副本、一般纳税人资格证书、银行开户许可证复印件，通过传真，或提供扫描件发送至京东客服。<br>传真号码：010-58043575<br>邮箱地址：kaipiaoxinxi@360buy.com<br>我们收到您的开票资料后，将会尽快审核。<br><br><font
																						color="ff6600">注意：有效增值税发票开票资质仅为一个。</font>
																</td>
															</tr>
														</tbody>
													</table>
															...
															<td><span id="invoince_contentPanel"> <input
																	...
																	name="invoince_content"><label
																		...
																		id="invoince_content2" name="invoince_content"><label
																			for="invoince_content2">办公用品</label> <input
																			type="radio" value="3"
																			onclick="invoince_setContent(3)"
																			id="invoince_content3" name="invoince_content"><label
																				for="invoince_content3">电脑配件</label> <input
																				type="radio" value="19"
																				onclick="invoince_setContent(19)"
																				id="invoince_content19" name="invoince_content"><label
																					for="invoince_content19">耗材</label></span></td>
														</tr>
														<tr>
																...
																id="InvoiceContentBookPanel"><span
																	id="InvoiceContentBookPanelSpan"> <input
																		...
																		id="invoince_contentBook4" name="invoince_contentBook"><label
																			...
																			id="invoince_contentBook7"
																			name="invoince_contentBook"><label
																				for="invoince_contentBook7">资料</label> <input
																				type="radio" value="6"
																				onclick="invoince_setContentBook(6)"
																				id="invoince_contentBook6"
																				name="invoince_contentBook"><label
																					for="invoince_contentBook6">教材</label></span></span></td>
														</tr>
													</tbody>
												</table>
											</td>
								...
								<div style="display: none">
									<input type="text" value="1" id="invoice_InvoiceType">
										<input type="text" value="4" id="invoice_InvoiceTitle">
											<input type="text" value="1" id="invoice_Invoice_Content">
												<input type="text" value="0" id="invoice_InvoicePutType">
													<input type="text" value="0"
													id="invoice_Invoice_ContentBook"> <input
														type="text" value="0" id="invoice_IsOnlyBook"> <input
						...
						<div class="middle">
							...
							<ul id="part_info">
								...
								<li style="padding-bottom: 5px" class="info1">
									商品金额：1698.00元 + 运费：0.00元 - 优惠券：<span id="price_coupon">0.00</span>元
									- 礼品卡：<span id="price_coupon">0.00</span>元 - 返现：0.00元 <input
									type="hidden" value="0" id="txtIsUseMoney"> <br>
								</li>
												...
												<td>
													...
													<div style="display:">
														<a onclick="showTicket();this.blur();"
															...
															id="couponStateShow">+</span>)使用优惠券抵消部分总额
									...
									<div style="display: none;" id="shitiPanel">
										<div style="padding-left: 10px; pading-top: 5px;">
											请输入您手中优惠券的密码：<input type="text" class="txt" id="txtInputKey">&nbsp;<input
												...
												;="" onclick="addShiTiCoupon(this);" id="btnAddYHQ"
					...
					<div class="safepsd01" id="paypasswordPanel" style="display: none;">
						...
						<div class="fl">
							<input type="password" class="text" id="txt_paypassword"><div
									class="msg-text">
									<a target="_blank"
	...
	<!----foot---->
	<div class="w footline">
		<div class="footserve">
			<img src="../images/foot1.jpg" width="133" height="54" />
			<ul>
				<li><a href="#">购物流程</a></li>
				<li><a href="#">会员介绍</a></li>
		...
		<div class="footserve">
			<img src="../images/foot2.jpg" width="133" height="54" />
			<ul>
				<li><a href="#">上门自提</a></li>
				<li><a href="#">快递运输</a></li>
		...
		<div class="footserve">
			<img src="../images/foot3.jpg" width="133" height="54" />
			<ul>
				<li><a href="#">货到付款</a></li>
				<li><a href="#">在线支付</a></li>
				<li><a href="#">分期付款</a></li>
		...
		<div class="footserve">
			<img src="../images/foot4.jpg" width="133" height="54" />
			<ul>
		...
		<div class="footserve" style="background: none">
			<img src="../images/foot5.jpg" width="133" height="54" />
			<ul>
				<li><a href="#">夺宝岛</a></li>
