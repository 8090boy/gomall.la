...
<table class="tables" cellpadding="0" cellspacing="0">
	<tr>
		<td class="titlebg"><c:choose>
				<c:when
					test="${(not empty User_Messages.code) and (User_Messages.code != 200)}">
					<SPAN class="afterOperate"><fmt:message key="operation.fail" /></SPAN>
				</c:when>
				<c:otherwise>
					<SPAN class="afterOperate"><fmt:message
							key="operation.successful" /></SPAN>
				</c:otherwise>
			</c:choose> <br></td>
	</tr>
	<tr>
	...
	<tr>
		<td bgcolor="#FFFFF6"><br></br>
			<div align="center">
				<input type="submit" onclick="javascript:turnToIndex()"
