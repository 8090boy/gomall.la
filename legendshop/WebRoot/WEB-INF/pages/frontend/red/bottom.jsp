...
<div class="w footline">
	<div class="footserve">
		<img src="${pageContext.request.contextPath}/images/foot1.jpg"
			width="133" height="54" />
		<ul>
			<li><a href="#">购物流程</a></li>
			<li><a href="#">会员介绍</a></li>
	...
	<div class="footserve">
		<img src="${pageContext.request.contextPath}/images/foot2.jpg"
			width="133" height="54" />
		<ul>
			<li><a href="#">上门自提</a></li>
			<li><a href="#">快递运输</a></li>
	...
	<div class="footserve">
		<img src="${pageContext.request.contextPath}/images/foot3.jpg"
			width="133" height="54" />
		<ul>
			<li><a href="#">货到付款</a></li>
			<li><a href="#">在线支付</a></li>
	...
	<div class="footserve">
		<img src="${pageContext.request.contextPath}/images/foot4.jpg"
			width="133" height="54" />
		<ul>
	...
	<div class="footserve" style="background: none">
		<img src="${pageContext.request.contextPath}/images/foot5.jpg"
			width="133" height="54" />
		<ul>
			<li><a href="#">夺宝岛</a></li>
