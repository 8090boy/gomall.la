...
<body topmargin="0">
	...
	<table width="500" cellspacing="2" cellpadding="2" align="center">
		<tr valign="middle" height="100px">
			<td align="center" style="font-family: serif; font-size: 1.5em;"><ls:i18n
					key="no.login.hint" /></td>
		</tr>
		<tr>
			<td height="80px" align="left" style="margin-left: 80px;"><ls:i18n
					key="nologin.hint" login="<ls:url address='/login'/>"
					reg="<ls:url address='/reg'/>" /></td>
		</tr>
	</table>
</body>
</html>
