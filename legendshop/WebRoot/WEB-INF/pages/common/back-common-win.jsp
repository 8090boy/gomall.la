...
@import
	url("${pageContext.request.contextPath}/common/default/css/screen.css")
	;
</style>
<jsp:scriptlet> 
	 String lClass = "simple";
	 ShopDetailView shopDetail = (ShopDetailView)request.getAttribute("shopDetailView");
	 if(shopDetail != null){
