...
<body>
    ...
    %>
	<form action="${pageContext.request.contextPath}/admin/myleague/query"
			...
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="${pageContext.request.contextPath}/admin/myleague/query">加盟商城管理</a></th>
				</tr>
			</thead>
			<tbody>
				<tr>
               ...
               <input type="text" name="userId" maxlength="50"
							...
							<input type="hidden" id="curPageNO" name="curPageNO"
								value="${curPageNO}" />加盟商城 <input type="text" name="friendId"
								maxlength="50" value="${bean.friendId}" /> <input type="submit"
								value="搜索" />
						</div>
					</td>
				</tr>
	...
	<div align="center">
		...
		<display:table name="list" requestURI="/admin/myleague/query"
			...
			<auth:auth ifAnyGranted="FA_SHOP">
				<display:column title="操作" media="html" class="actionwidth">
					<a
						href="${pageContext.request.contextPath}/admin/myleague/load/${item.id}"><img
						alt="修改"
	...
	<table style="width: 100%; border: 0px">
		<tr>
			<td align="left">说明：<br> 1.
				加盟商城将会出现在您的商城的加盟商城页面，用于商城之间的导航和组成联盟关系<br> 2.
				请在前台浏览商城时将你喜欢的商城加为加盟商城，没有任何限制<br> 3. 删除加盟商城之后将不会在前台显示<br>
			</td>
		<tr>
	</table>
