...
<body>
	<form action="${pageContext.request.contextPath}/admin/myleague/update"
		...
		<div align="center">
				...
				<thead>
					<tr>
						<th><a href="<ls:url address='/admin/index'/>"
							...
							href="${pageContext.request.contextPath}/admin/myleague/query">加盟商城管理</a>
							&raquo; 加盟商城</th>
					</tr>
				</thead>
			</table>
			<table align="center" class="${tableclass}" id="col1">
				...
				<tr>
					<td>
						<div align="right">
							加盟商城<font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="friendId" id="friendId"
						value="${bean.friendId}" readonly="readonly" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">加盟商城</div>
					</td>
					<td><input type="text" name="friendName" id="friendName"
						value="${bean.friendName}" /></td>
				</tr>
				<tr>
					<td>
