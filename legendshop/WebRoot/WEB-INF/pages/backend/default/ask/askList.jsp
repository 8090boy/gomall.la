...
@import
	url("<ls:templateResource item='/common/default/css/screen.css'/>");
</style>
<title>Ask列表</title>
</head>
<body>
	<form action="<ls:url address='/admin/ask/query'/>" id="form1"
		method="post">
			...
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="<ls:url address='/admin/ask/query'/>">Ask</a></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td>
						<div align="left" style="padding: 3px">
							...
							<auth:auth ifAnyGranted="F_VIEW_ALL_DATA">
				            	商城&nbsp;<input type="text" name="userName"
									maxlength="50" value="${ask.userName}" />
							</auth:auth>
							<input type="submit" value="搜索" /> <input type="button"
								value="创建Ask"
								onclick='window.location="<ls:url address='/admin/ask/load'/>"' />
						</div>
					</td>
				</tr>
			</tbody>
	...
	<div align="center">
		...
		<display:table name="list" requestURI="/admin/ask/query" id="item"
			...
			<display:column title="Action" media="html">
				<a href="<ls:url address='/admin/ask/load/${item.askId}'/>"
					title="修改"> <img alt="修改"
					src="<ls:templateResource item='/common/default/images/grid_edit.png'/>">
				</a>
				<a href='javascript:deleteById("${item.askId}")' title="删除"> <img
					alt="删除"
