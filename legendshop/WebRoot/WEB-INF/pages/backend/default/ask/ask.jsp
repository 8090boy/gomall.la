...
<body>
	<form action="<ls:url address='/admin/ask/save'/>" method="post"
		id="form1">
		...
		<div align="center">
			<table border="0" align="center" class="${tableclass}" id="col1">
				...
				<tr>
					<td>< align="center">Type: <font color="ff0000">*</font>
					</div>
					</td>
					<td>
						<p>
							<input type="text" name="type" id="type" value="${ask.type}" />
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<div align="center">
							Comment: <font color="ff0000">*</font>
						</div>
					</td>
					<td>
						<p>
					...
					<td>
						<p>
							<input type="text" name="createTime" id="createTime"
								value="${ask.createTime}" />
					</td>
				</tr>
				<tr>
					<td>
						<div align="center">
							ReplyTime: <font color="ff0000">*</font>
						</div>
					</td>
					<td>
						<p>
							<input type="text" name="replyTime" id="replyTime"
								value="${ask.replyTime}" />
					</td>
				</tr>
