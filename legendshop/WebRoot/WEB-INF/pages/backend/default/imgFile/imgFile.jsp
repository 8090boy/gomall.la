		...
		<div align="center">
			<table border="0" align="center" class="${tableclass}" id="col1">
				<thead>
					<tr class="sortable">
						<th colspan="2">
							<div align="center">创建 ImgFile</div>
						</th>
					</tr>
				</thead>
				<tr>
				...
				<tr>
					<td>
						<div align="center">
							ProductId: <font color="ff0000">*</font>
						</div>
					</td>
				...
				<tr>
					<td>
						<div align="center">
							ProductType: <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="productType" id="productType"
						value="${bean.productType}" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">
							FilePath: <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="filePath" id="filePath"
						value="${bean.filePath}" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">
							FileType: <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="fileType" id="fileType"
						value="${bean.fileType}" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">
							FileSize: <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="fileSize" id="fileSize"
						value="${bean.fileSize}" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">
							UpoadTime: <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="upoadTime" id="upoadTime"
						value="${bean.upoadTime}" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">
