...
<body>
	<form action="${pageContext.request.contextPath}/admin/visitLog/save"
		method="post" id="form1">
		<input id="visitId" name="visitId" value="${bean.visitId}"
			type="hidden" />
		<div align="center">
			<table border="0" align="center" class="${tableclass}" id="col1">
				<thead>
					<tr class="sortable">
						<th colspan="2">
							<div align="center">创建 VisitLog</div>
						</th>
					</tr>
				</thead>
				<tr>
					...
					<td><input type="text" name="ip" id="ip" value="${bean.ip}" />
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<div align="center">
							ShopName: <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="shopName" id="shopName"
						value="${bean.shopName}" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">
							ProductName: <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="productName" id="productName"
						value="${bean.productName}" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">
							Page: <font color="ff0000">*</font>
						</div>
					</td>
