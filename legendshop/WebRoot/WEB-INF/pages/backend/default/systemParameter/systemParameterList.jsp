...
<body>
		...
		<thead>
			<tr>
				<th><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a>
					&raquo; 系统管理 &raquo; <a
					href="${pageContext.request.contextPath}/admin/system/systemParameter/query/<%=groupId %>">
						<%=SysParamGroupEnum.getName(groupId)%></a></th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td>
					<div align="left" style="padding: 3px">
						<form
							action="${pageContext.request.contextPath}/admin/system/systemParameter/query/${groupId}"
							id="form1" method="post">
							<input type="hidden" id="curPageNO" name="curPageNO"
								value="${curPageNO}" /> &nbsp; 参数名称&nbsp;<input type="text"
								name="name" id="name" maxlength="50" size="50"
								value="${bean.name}" /> <input type="submit" value="搜索" />
						</form>
					</div>
				</td>
			</tr>
	...
	<div align="center">
		...
		<display:table name="list"
			requestURI="/admin/system/systemParameter/query/${groupId}" id="item"
			...
			<display:column title="操作" media="html">
				<a
					href="${pageContext.request.contextPath}/admin/system/systemParameter/load/${item.name}"
					title="修改"><img alt="修改"
