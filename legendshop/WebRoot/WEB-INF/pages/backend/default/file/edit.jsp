...
<body>
	<input id="parentFilePath" name="parentFilePath"
		value="${parentFilePath}" type="hidden">
	...
	<div align="center">
		...
		<table align="center" class="${tableclass}" id="col1"
			style="width: 100%">
			<tr>
				<td><textarea style="width: 100%; height: 400px" id="content"
					...
					<div align="center">
						<auth:auth ifAnyGranted="F_SYSTEM">
							<input type="submit" value="提交"
								onclick="javascript:saveFileContent()" />
						</auth:auth>
					</div>
				</td>
			</tr>
