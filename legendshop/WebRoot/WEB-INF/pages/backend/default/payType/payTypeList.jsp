...
<body>
    ...
    %>
	<form action="${pageContext.request.contextPath}/admin/paytype/query"
			...
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="${pageContext.request.contextPath}/admin/paytype/query">支付管理</a></th>
				</tr>
			</thead>
			<tbody>
				<tr>
           	...
           	用户名&nbsp;<input type="text" name="userName" maxlength="50"
							...
							<auth:auth ifAnyGranted="FA_PAY">
								<input type="button" value="创建支付方式"
									onclick='window.location="${pageContext.request.contextPath}/admin/paytype/load"' />
							</auth:auth>
						</div>
					</td>
				</tr>
		...
		<display:table name="list" requestURI="/admin/paytype/query" id="item"
			...
			<auth:auth ifAnyGranted="FA_PAY">
				<display:column title="操作" media="html" style="width:40px">
					<a
						href="${pageContext.request.contextPath}/admin/paytype/load/${item.payId}"
						title="修改"><img alt="修改"
						src="<ls:templateResource item='/common/default/images/grid_edit.png'/> "></a>
					<a href='javascript:deleteById("${item.payId}")' title="删除"><img
						alt="删除"
	...
	<table style="width: 100%; border: 0px">
		<tr>
			<td align="left">说明：<br> 1.
				创建支付方式，每个支付方式只需建立一个，建立之后用户在订购商品时可以选择该支付方式<br> 2. <img alt="修改"
