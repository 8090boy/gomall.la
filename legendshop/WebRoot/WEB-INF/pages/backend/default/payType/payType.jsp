...
<body>
	<form action="${pageContext.request.contextPath}/admin/paytype/save"
		...
		<div align="center">
			...
			<table align="center" class="${tableclass}" id="col1">
				...
				<tr>
					...
					<td><select id="payTypeId" name="payTypeId">
							<ls:optionGroup type="select" required="true" cache="true"
								beanId="paymentProcessors" selectedValue="${bean.payTypeId}" />
					</select></td>
				</tr>
				<tr>
					<td>
					...
					<td><input type="text" name="partner" id="partner"
						value="${bean.partner}" size="50" maxlength="100" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">安全检验码:</div>
					</td>
					<td><input type="text" name="validateKey" id="validateKey"
						value="${bean.validateKey}" size="50" maxlength="50" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">签约账号:</div>
					</td>
					<td><input type="text" name="sellerEmail" id="sellerEmail"
						value="${bean.sellerEmail}" size="50" maxlength="100" /></td>
				</tr>
				<tr>
					<td>
					...
					<td><input type="text" name="memo" id="memo"
						value="${bean.memo}" size="50" maxlength="100" /></td>
				</tr>
