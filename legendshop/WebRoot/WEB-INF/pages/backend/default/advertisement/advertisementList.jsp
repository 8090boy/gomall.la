...
<body>
    ...
    %>
	<form
		action="${pageContext.request.contextPath}/admin/advertisement/query"
		...
		<table class="${tableclass}" style="width: 100%">
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="${pageContext.request.contextPath}/admin/advertisement/query">广告管理</a></th>
				</tr>
			</thead>
			<tbody>
				<tr>
            ...
            <input type="text" name="userName" maxlength="50"
							...
							<auth:auth ifAnyGranted="FA_SHOP">
								<input type="button" value="创建广告"
									onclick='window.location="${pageContext.request.contextPath}/admin/advertisement/load"' />
							</auth:auth>
						</div>
					</td>
				</tr>
	...
	<div align="center">
		...
		<c:if test="${not empty list}">
			<display:table name="list" requestURI="/admin/advertisement/query"
				...
				<display:column title="类型" sortable="true">
					<ls:optionGroup type="label" required="true" cache="true"
						beanName="ADVERTISEMENT_TYPE" selectedValue="${item.type}"
						defaultDisp="" />
				</display:column>
				...
				<display:column title="图片">
					<a href="<ls:photo item='${item.picUrl}'/>" target="_blank"><img
						src="${pageContext.request.contextPath}/common/default/images/filter_search.png"></a>
					</a>
				</display:column>
				<auth:auth ifAnyGranted="FA_SHOP">
					<display:column title="操作" media="html" style="width: 80px">
						...
						<a
							href="${pageContext.request.contextPath}/admin/advertisement/load/${item.id}"
							title="修改"><img alt="修改"
