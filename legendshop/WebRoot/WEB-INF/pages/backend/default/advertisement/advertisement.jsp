...
<body>
	<form
		action="${pageContext.request.contextPath}/admin/advertisement/save"
				...
				<thead>
					<tr>
						<th><a href="<ls:url address='/admin/index'/>"
							...
							href="${pageContext.request.contextPath}/admin/advertisement/query">广告管理</a>
							&raquo; 创建广告</th>
					</tr>
				</thead>
			</table>
			<table align="center" class="${tableclass}" id="col1">
				...
				<tr>
					...
					<td><input type="text" name="title" id="title"
						value="${bean.title}" size="50" maxlength="255" /></td>
				</tr>
				<tr>
					<td>
					...
					<td><input type="text" name="sourceInput" id="sourceInput"
						value="${bean.sourceInput}" size="50" maxlength="255" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">
