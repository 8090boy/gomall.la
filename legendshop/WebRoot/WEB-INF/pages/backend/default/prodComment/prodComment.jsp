...
<body>
	<form
		action="${pageContext.request.contextPath}/admin/productcomment/save"
			...
			<table align="center" class="${tableclass}" id="col1">
				...
				<c:if test="${bean.replyName != null }">
					<tr>
						...
						<td>回复：${bean.replyName} 回复时间： <fmt:formatDate
								value="${bean.replyTime}" pattern="yyyy-MM-dd HH:mm" />
						</td>
					</tr>
				</c:if>
				<auth:auth ifAnyGranted="FA_PROD">
					<tr>
						...
						<td><textarea rows="5" cols="50" id="replyContent"
								name="replyContent">${bean.replyContent}</textarea></td>
					</tr>
					<tr>
						<td colspan="2">
							<div align="center">
