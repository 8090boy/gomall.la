...
<body>
	<form action="${pageContext.request.contextPath}/admin/brand/save"
			...
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="${pageContext.request.contextPath}/admin/brand/query">品牌管理</a>
						&raquo; <a href="<ls:url address='/admin/brand/load'/>" />创建品牌</a></th>
				</tr>
			</thead>
		</table>
		<input id="brandId" name="brandId" value="${bean.brandId}"
			type="hidden">
		<div align="center">
			<table align="center" class="${tableclass}" id="col1">
				...
				<tr>
					<td>
						<div align="center">
							品牌 <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="brandName" id="brandName"
						value="${bean.brandName}" maxlength="30" /></td>
				</tr>
				<tr>
					<td>
					...
					<td><input type="file" name="file" id="file" /> <input
						type="hidden" name="brandPic" id="brandPic"
						value="${bean.brandPic}" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">次序</div>
					</td>
					<td><input type="text" name="seq" id="seq" value="${bean.seq}"
				...
				<tr>
					...
					<td><input type="text" name="memo" id="memo"
						value="${bean.memo}" size="31" maxlength="50" /></td>
				</tr>
				<c:if test="${bean.brandPic!=null}">
					<tr>
						<td>
							<div align="center">原有图片</div>
						</td>
						<td><a href="<ls:photo item='${bean.brandPic}'/>"
							target="_blank"> <img
								src="<ls:photo item='${bean.brandPic}'/>" height="65" /></a></td>
					</tr>
				</c:if>
