...
<body>
	<auth:auth ifAnyGranted="F_SYSTEM">
			...
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="${pageContext.request.contextPath}/admin/loginHistory/sum">用户登录次数历史列表</a></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td>
						<div align="left" style="padding: 3px">
							<form
								action="${pageContext.request.contextPath}/admin/loginHistory/sum"
								id="form1">
		...
		<div align="center">
			...
			<display:table name="list" requestURI="/admin/loginHistory/sum"
