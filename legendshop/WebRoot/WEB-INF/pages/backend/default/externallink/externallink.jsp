		...
		<thead>
			<tr>
				<th><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a>
					&raquo; 商城管理 &raquo; <a
					href="${pageContext.request.contextPath}/admin/externallink/query">连接管理</a>
					&raquo; 创建友情连接</th>
			</tr>
		</thead>
	</table>
	<form
		action="${pageContext.request.contextPath}/admin/externallink/save"
		...
		<div align="center">
			<table align="center" class="${tableclass}" id="col1">
				...
				<tr>
					<td>
						<div align="right">
							连接地址<font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="url" id="url" value="${bean.url}"
						size="50" maxlength="300" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">
							连接显示文字<font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="wordlink" id="wordlink"
						value="${bean.wordlink}" size="50" maxlength="50" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">
				...
				<tr>
					...
					<td><input type="file" name="file" id="file" size="50" /> <input
						type="hidden" name="picture" id="picture" size="80"
						value="${bean.picture}" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">次序（数字，越小越靠前）</div>
					</td>
					<td><input type="text" name="bs" id="bs" value="${bean.bs}" />
					</td>
				</tr>
				<tr>
					<td colspan="2">
