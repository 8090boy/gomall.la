...
<body>
	<form action="<ls:url address='/admin/partner/query'/>" id="form1"
		method="post">
		<table class="${tableclass}" style="width: 100%">
			...
			<tbody>
            	...
            	商城&nbsp;<input type="text" name="userName" maxlength="50"
							...
							&nbsp;&nbsp;登录名&nbsp;<input type="text" name="partnerName"
								maxlength="50" value="${partner.partnerName}" /> <input
								type="submit" value="搜索" /> <input type="button" value="创建供应商"
								onclick='window.location="<ls:url address='/admin/partner/load'/>"' />
						</div>
					</td>
				</tr>
			</tbody>
	...
	<div align="center">
		...
		<display:table name="list" requestURI="/admin/partner/query" id="item"
			...
			<display:column title="操作" media="html">
				<a href="<ls:url address='/admin/partner/load/${item.partnerId}'/>"
					title="修改"> <img alt="修改"
				...
				<a
					href="<ls:url address='/admin/partner/changePassword/${item.partnerId}'/>"
					title="修改密码">修改密码</a>
			</display:column>
		</display:table>
