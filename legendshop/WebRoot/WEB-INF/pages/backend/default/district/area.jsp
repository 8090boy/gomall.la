...
<body>
	<form action="<ls:url address='/admin/system/district/savearea'/>"
		method="post" id="form1">
		<input id="id" name="id" value="${area.id}" type="hidden"> <input
			id="cityid" name="cityid" value="${city.id}" type="hidden">
		<div align="center">
			<table border="0" align="center" class="${tableclass}" id="col1"
				...
				<thead>
					<tr class="sortable">
						<th colspan="2">
							<div align="center">[${province.province }/${city.city }]
								-地区管理</div>
						</th>
					</tr>
				</thead>
				...
				<tr>
					...
					<td><input type="text" name="area" id="area"
						value="${area.area}" maxlength="50" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">
					...
					<td><input type="text" name="areaid" id="areaid"
						value="${area.areaid}" maxlength="20" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">
							区号: <font color="ff0000">*</font>
						</div>
					</td>
