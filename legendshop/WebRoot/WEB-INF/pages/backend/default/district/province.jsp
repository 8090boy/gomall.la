...
<body>
	<form action="<ls:url address='/admin/system/district/save'/>"
			...
			<table border="0" align="center" class="${tableclass}" id="col1"
				...
				<tr>
					...
					<td><input type="text" name="province" id="province"
						value="${province.province}" maxlength="50" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">
					...
					<td><input type="text" name="provinceid" id="provinceid"
						value="${province.provinceid}" maxlength="20" /></td>
				</tr>
				<tr>
					<td colspan="2">
						<div align="center">
