...
<body>
	<form action="${pageContext.request.contextPath}/admin/pub/save"
		...
		<div align="center">
				...
				<thead>
					<tr>
						<th><a href="<ls:url address='/admin/index'/>"
							...
							href="${pageContext.request.contextPath}/admin/pub/query">公告管理</a>
							&raquo; 创建公告</th>
					</tr>
				</thead>
			</table>
			<table style="width: 100%" class="${tableclass}" id="col1">
				...
				<tr>
					...
					<td><auth:auth ifAnyGranted="FA_SHOP">
							<FCK:editor instanceName="msg" height="400px" width="100%"
