...
<body>
    ...
    %>
	<form action="${pageContext.request.contextPath}/admin/pub/query"
		...
		<table class="${tableclass}" style="width: 100%">
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="${pageContext.request.contextPath}/admin/pub/query">公告管理</a></th>
				</tr>
			</thead>
			<tbody>
				<tr>
           ...
           用户名称 <input type="text" name="userName" maxlength="50"
							...
							&nbsp;开始时间 <input readonly="readonly" name="startDate"
							...
							<auth:auth ifAnyGranted="FA_SHOP">
								<input type="button" value="创建公告"
									onclick='window.location="${pageContext.request.contextPath}/admin/pub/load"' />
							</auth:auth>
						</div>
					</td>
				</tr>
	...
	<div align="center">
		...
		<display:table name="list" requestURI="/admin/pub/query" id="item"
			...
			<display:column title="有效日期" property="startDate"
				format="{0,date,yyyy-MM-dd}" sortable="true"></display:column>
			<display:column title="结束日期" property="endDate"
				format="{0,date,yyyy-MM-dd}" sortable="true"></display:column>
			<auth:auth ifAnyGranted="FA_SHOP">
				<display:column title="操作" media="html" style="width:80px">
					...
					<a
						href="${pageContext.request.contextPath}/admin/pub/load/${item.id}"
						title="修改"><img alt="修改"
	...
	<table style="width: 100%; border: 0px">
		<tr>
			<td align="left">说明：<br> 1. 出现在商城首页，用于商家发布公告信息<br>
			</td>
		<tr>
	</table>
