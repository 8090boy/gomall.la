...
<div class="cc-cbox-filter">
	<label for="cc-cbox-filter3">输入三级商品分类</label><input role="textbox"
		autocomplete="off" id="cc-cbox-filter3" style="width: 175px;"
		class="lebelinput">
</div>
<ul role="listbox" class="cc-cbox-cont" id="subSortList"
	name="subSortList">
	<c:forEach items="${requestScope.nSort3List }" var="nsort3">
		<li id="cc-cbox-item${nsort3.nsortId}" sortId="${nsort3.nsortId}"
			class="cc-cbox-item">
			<!-- 
											<i>c</i> 
											 --> ${nsort3.nsortName }
