...
<div id="form1">
	...
	<p>
		<label>激活码：<input id="liensekey" name="liensekey" type="text"></label>
	</p>
	<p>
		<label>验证码：<input id="randNum" name="randNum" type="text"
			maxlength="4" size="7" tabindex="3"> <img id="randImage"
			name="randImage" src="<ls:templateResource item='/captcha.svl'/>"
			style="vertical-align: top;" /> <a href="javascript:void(0)"
			onclick="javascript:changeRandImg('${pageContext.request.contextPath}')"
			style="font-weight: bold;"> <fmt:message key="change.random2" />
		</a>
		</label>
	</p>
</div>
