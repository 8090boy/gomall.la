...
<body>
    ...
    %>
	<form action="<ls:url address='/admin/hotsearch/query'/>" id="form1"
		method="post">
			...
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="<ls:url address='/admin/hotsearch/query'/>">热门商品管理</a></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td>
						<div align="left" style="padding: 3px">
							<input type="hidden" id="curPageNO" name="curPageNO"
								value="${curPageNO}" /> 标题 <input type="text" name="title"
								maxlength="50" value="${bean.title}" size="30" /> 商品类型
             ...
             商城&nbsp;<input type="text" name="userName" maxlength="50"
							...
							<auth:auth ifAnyGranted="FA_PROD">
								<input type="button" value="创建热门商品"
									onclick='window.location="${pageContext.request.contextPath}/admin/hotsearch/load"' />
							</auth:auth>
						</div>
					</td>
				</tr>
	...
	<div align="center">
		...
		<display:table name="list" requestURI="/admin/hotsearch/query"
			...
			<auth:auth ifAnyGranted="FA_PROD">
				<display:column title="操作" media="html" style="width:80px">
					...
					<a href="<ls:url address='/admin/hotsearch/load/${item.id}'/>"
						title="修改"><img alt="修改"
	...
	<table style="width: 100%; border: 0px">
		<tr>
			<td align="left">说明：<br> 1. 热门商品出现在一级商品类型的首页<br> 2. <img
				alt="修改"
				src="<ls:templateResource item='/common/default/images/grid_edit.png'/> ">
				修改按钮<br> 3. <img alt="删除"
