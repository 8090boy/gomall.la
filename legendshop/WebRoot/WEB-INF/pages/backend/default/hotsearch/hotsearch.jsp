...
<body>
	<form action="${pageContext.request.contextPath}/admin/hotsearch/save"
		...
		<div align="center">
				...
				<thead>
					<tr>
						<th><a href="<ls:url address='/admin/index'/>"
							...
							href="<ls:url address='/admin/hotsearch/query'/>">热门商品管理</a>
							&raquo; 创建热门商品</th>
					</tr>
				</thead>
			</table>
			<table align="center" class="${tableclass}" id="col1"
				...
				<tr>
					<td width="200px">
						<div align="right">
							商品标题(用于全文检索)<font color="ff0000">*</font>
						</div>
					</td>
				...
				<tr>
					<td>
						<div align="right">
							查询内容<font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="msg" id="msg" value="${bean.msg}"
						size="50" /></td>
				</tr>
				<tr>
					<td>
					...
					<td><lb:sortOption id="sort" type="P"
							selectedValue="${bean.sort}" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">
