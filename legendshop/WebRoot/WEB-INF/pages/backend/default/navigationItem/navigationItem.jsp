...
<body>
	<form action="<ls:url address='/admin/system/navigationItem/save'/>"
		method="post" id="form1">
		<input id="naviId" name="naviId" value="${navigation.naviId}"
			type="hidden"> <input id="itemId" name="itemId"
			value="${navigationItem.itemId}" type="hidden">
		<div align="center">
			<table border="0" align="center" class="${tableclass}" id="col1"
				...
				<tr>
					...
					<td><input type="text" name="name" id="name"
						value="${navigationItem.name}" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">
							连接: <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="link" id="link"
						value="${navigationItem.link}" style="width: 450px" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">
