...
<body>
	...
	前台模版：
	<select id="frontEndTemplet" name="frontEndTemplet"></select> 语言：
	<select id="frontEndLanguage" name="frontEndLanguage"></select> 风格：
	<select id="frontEndStyle" name="frontEndStyle"></select>
	<br></br> 后台模版：
	<select id="backEndTemplet" name="backEndTemplet"></select> 语言：
	<select id="backEndLanguage" name="backEndLanguage"></select> 风格：
