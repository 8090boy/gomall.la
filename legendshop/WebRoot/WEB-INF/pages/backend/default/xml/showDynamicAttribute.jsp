...
<link rel="stylesheet" type="text/css" media='screen'
	href="<ls:templateResource item='/common/default/css/prodAttribute.css'/> " />
		...
		<tr>
			...
			<td>
				<ul id="modelId${pos.index}">
					<input type="hidden" autocomplete="off" id="prodAttr${pos.index}"
						name="prodAttr${pos.index}" dataValue="${model.id}"
						class="attrselect" value=""> <c:forEach
							items="${model.items}" var="item" varStatus="status">
