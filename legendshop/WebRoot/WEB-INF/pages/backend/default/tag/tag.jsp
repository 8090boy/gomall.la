...
<body>
	<form action="<ls:url address='/admin/tag/save'/>" method="post"
		id="form1">
			...
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="<ls:url address='/admin/tag/query'/>">标签管理</a></th>
				</tr>
			</thead>
		</table>
		<div align="center">
			<table border="0" align="center" class="${tableclass}" id="col1">
				...
				<tr>
					...
					<td><select id="sortId" name="sortId">
							<ls:optionGroup type="select" required="false" cache="fasle"
								defaultDisp="-- 一级类型 --"
								hql="select t.sortId, t.sortName from Sort t where  t.status = 1 and t.sortType = 'P' and t.userName = ?"
								param="${tag.userName}" selectedValue="${tag.sortId}" />
					</select></td>
				</tr>
				<tr>
					<td>
						<div align="center">
							新闻栏目<font color="ff0000">*</font>
						</div>
					</td>
					<td><select id="newsCategoryId" name="newsCategoryId">
							<ls:optionGroup type="select" required="false" cache="fasle"
								...
								param="${tag.userName}" selectedValue="${tag.newsCategoryId}" />
					</select></td>
				</tr>
				<tr>
					<td>
