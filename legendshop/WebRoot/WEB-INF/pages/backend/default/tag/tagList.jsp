...
<body>
	<form action="<ls:url address='/admin/tag/query'/>" id="form1"
		method="post">
					...
					<td>
						<div align="left" style="padding: 3px">
							<input type="hidden" id="curPageNO" name="curPageNO"
								value="${curPageNO}" /> 标签名称&nbsp;<input type="text"
								name="name" maxlength="50" value="${tag.name}" />
            	...
            	商城&nbsp;<input type="text" name="userName" maxlength="50"
							...
							<auth:auth ifAnyGranted="FA_SHOP">
								<input type="button" value="创建标签"
									onclick='window.location="<ls:url address='/admin/tag/load'/>"' />
							</auth:auth>
						</div>
					</td>
				</tr>
	...
	<div align="center">
		...
		<display:table name="list" requestURI="/admin/tag/query" id="item"
			...
			<auth:auth ifAnyGranted="FA_SHOP">
				<display:column title="操作" media="html">
					<a href="<ls:url address='/admin/tag/update/${item.tagId}'/>"
						title="增加产品"> <img alt="增加产品"
					...
					<a href='javascript:deleteById("${item.tagId}")' title="删除"> <img
						alt="删除"
