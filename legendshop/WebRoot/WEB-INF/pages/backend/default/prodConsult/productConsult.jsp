...
<body>
	<form
		action="${pageContext.request.contextPath}/admin/productConsult/save"
		method="post" id="form1">
		<input id="consId" name="consId" value="${productConsult.consId}"
			type="hidden">
		<div align="center">
			<table align="center" class="${tableclass}" id="col1">
				...
				<tr>
					...
					<td><ls:optionGroup type="label" required="false" cache="true"
							beanName="CONSULT_TYPE"
							selectedValue="${productConsult.pointType}" defaultDisp="" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">咨询内容</div>
					</td>
					<td>${productConsult.content}</td>
				</tr>
				<tr>
					<td>
						<div align="center">咨询时间</div>
					</td>
					<td><fmt:formatDate value="${productConsult.recDate}"
				...
				<c:if test="${productConsult.ansUserName != null }">
					<tr>
						...
						<td>回复人：${productConsult.ansUserName} 回复时间： <fmt:formatDate
								value="${productConsult.answertime}" pattern="yyyy-MM-dd HH:mm" />
						</td>
					</tr>
				</c:if>
				<auth:auth ifAllGranted="FA_PROD">
					<tr>
						<td>
							<div align="center">
								回复内容 <font color="ff0000">*</font>
							</div>
						</td>
						<td><textarea rows="5" cols="50" id="answer" name="answer">${productConsult.answer}</textarea>
						</td>
					</tr>
					<tr>
						<td colspan="2">
