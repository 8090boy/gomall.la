...
<body>
	<form action="<ls:url address='/admin/productSpec/query'/>" id="form1"
		method="post">
			...
			<thead>
				<tr>
					<td><a href="<ls:url address='/admin/index'/>"
						...
						href="<ls:url address='/admin/productSpec/query'/>">产品规范</a></td>
				</tr>
			</thead>
		</table>
		...
		<auth:auth ifAnyGranted="F_VIEW_ALL_DATA">
				...
				value="${productSpec.userName}" />
		</auth:auth>
		<input type="submit" value="搜索" /> <input type="button" value="创建产品规范"
			onclick='window.location="<ls:url address='/admin/productSpec/load'/>"' />
		<br>
	</form>
	<div align="center">
		<%@ include file="/WEB-INF/pages/common/messages.jsp"%>
		<display:table name="list" requestURI="/admin/productSpec/query"
			...
			<display:column title="Action" media="html">
				<a
					href="<ls:url address='/admin/productSpec/load/${item.prodSpecId}'/>"
					title="修改"> <img alt="修改"
