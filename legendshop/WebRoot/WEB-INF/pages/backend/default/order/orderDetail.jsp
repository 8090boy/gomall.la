...
<title>${sub.subNumber} <fmt:message
		key="product.subscribed.list" />
</title>
</head>
<body>
		...
		<tr>
			<td>
				<table width="100%" align="left">
					<tr>
						<td width="45%"><div align="left" style="margin-left: 5px">
								<fmt:message key="dateStr" />
								：
								<fmt:formatDate value="${sub.subDate}"
									pattern="yyyy-MM-dd HH:mm" />
							</div></td>
						<td width="55%"><div align="left" style="margin-left: 5px">
								<fmt:message key="Payment.Date" />
								：
								<fmt:formatDate value="${sub.payDate}"
									pattern="yyyy-MM-dd HH:mm" />
							</div></td>
					</tr>
					<tr>
					...
					<tr>
						<td><div align="left" style="margin-left: 5px">
								...
								<ls:optionGroup type="label" required="true" cache="true"
									beanName="ORDER_STATUS" selectedValue="${sub.status}"
									defaultDisp="" />
							</div></td>
						<td><div align="left" style="margin-left: 5px">
					...
					<tr>
						<td><div align="left" style="margin-left: 5px">
								<fmt:message key="charge.amount" />
								：<b><fmt:formatNumber type="currency"
										value="${sub.actualTotal}" pattern="${CURRENCY_PATTERN}" /></b>
								<c:if test="${sub.score ne null}">(<fmt:message
										key="score.hint" />：${sub.score})</c:if>
							</div></td>
						<td><div align="left" style="margin-left: 5px">
								<fmt:message key="Order.Update.Date" />
								：
								<fmt:formatDate value="${sub.updateDate}"
									pattern="yyyy-MM-dd HH:mm" />
							</div></td>
					</tr>
					<tr>
						<td colspan="2">
							<table width="100%" cellspacing="0" cellpadding="0">
								<tr>
									<td width="20%"><div align="left" style="margin-left: 5px">
		...
		<tr>
			<td width="100%">
				<table width="100%" cellpadding="2" cellspacing="2">
						...
						<tr>
							<td><div align="center">
									<a target="_blank"
										...
										color="#FF0000">${basket.prodName}</font></a>
								</div></td>
                    ...
                    (<fmt:message key="carriage.charge" />：<fmt:formatNumber
											type="currency" value="${basket.carriage}"
							...
							<td>
								<div align="center">
									<fmt:formatDate value="${basket.basketDate}"
										pattern="yyyy-MM-dd HH:mm" />
								</div>
							</td>
