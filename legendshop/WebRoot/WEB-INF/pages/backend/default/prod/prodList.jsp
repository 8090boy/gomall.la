		...
		<thead>
			<tr>
				<th><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a>
					&raquo; 商品管理 &raquo; <a
					href="<ls:url address='/admin/product/query'/>">商品管理</a></th>
			</tr>
		</thead>
		<tbody>
			<tr>
            ...
            <input type="text" id="userName" name="userName"
								maxlength="50" value="${prod.userName}" size="15" />
						</auth:auth>
			  ...
			  商品类型&nbsp;
							...
							<select class="combox" id="nsortId" name="nsortId"
							...
							<select class="combox" id="subNsortId" name="subNsortId"
							...
							<select class="combox" id="brandId" name="brandId"
					...
					<div align="left" style="padding: 3px">
						商品&nbsp; <input type="text" name="name" id="name" maxlength="50"
							value="${prod.name}" size="32" /> 精品 <select id="commend"
							name="commend">
							<option value="">请选择</option>
							<option value="Y">是</option>
							<option value="N">否</option>
						</select> 热门 <select id="hot" name="hot">
							<option value="">请选择</option>
							<option value="Y">是</option>
							<option value="N">否</option>
						...
						</select> <input type="button" value="搜索" onclick="javascript:sendData()" />
						<auth:auth ifAnyGranted="FA_PROD">
							<input type="button" value="创建商品"
								onclick='window.location="${pageContext.request.contextPath}/admin/sort/publish"' />
						</auth:auth>
					</div></td>
			</tr>
		</tbody>
