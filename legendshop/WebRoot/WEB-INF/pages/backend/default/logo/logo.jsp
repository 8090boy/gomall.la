...
<body>
	<form action="${pageContext.request.contextPath}/admin/logo/save"
		...
		<div align="center">
				...
				<thead>
					<tr>
						<th><a href="<ls:url address='/admin/index'/>"
							...
							href="${pageContext.request.contextPath}/admin/logo/query">Logo管理</a>
							&raquo; 创建 Logo</th>
					</tr>
				</thead>
			</table>
			<table align="center" class="${tableclass}" id="col1">
				...
				<tr>
					<td>
						<div align="right">
							上传图片(170px*60px) <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="file" name="file" id="file" /> <input
						type="hidden" name="bannerName" id="bannerName" size="80"
						value="${bean.logoPic}" /></td>
				</tr>
				<c:if test="${bean.logoPic!=null}">
					<tr>
						...
						<td><a href="<ls:photo item='${bean.logoPic}'/>"
							target="_blank"> <img
