...
<body>
	<form action="<ls:url address='/admin/system/navigation/save'/>"
			...
			<table border="0" align="center" class="${tableclass}" id="col1"
				...
				<tr>
					...
					<td><input type="text" name="name" id="name"
						value="${navigation.name}" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">
							次序: <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="seq" id="seq"
						value="${navigation.seq}" /></td>
				</tr>
				<tr>
					<td>
						<div align="right">
