...
<body>
	<form action="<ls:url address='/admin/cashFlow/save'/>" method="post"
		id="form1">
		<input id="flowId" name="flowId" value="${cashFlow.flowId}"
			type="hidden">
		<div align="center">
			<table border="0" align="center" class="${tableclass}" id="col1">
				<thead>
					<tr class="sortable">
						<th colspan="2">
							<div align="center">创建CashFlow</div>
						</th>
					</tr>
				</thead>
				<tr>
					...
					<td>
						<p>
							<input type="text" name="userName" id="userName"
								value="${cashFlow.userName}" />
					</td>
				</tr>
				<tr>
					<td>
						<div align="center">
							inId: <font color="ff0000">*</font>
						</div>
					</td>
					<td>
						<p>
							<input type="text" name="adminId" id="adminId"
								value="${cashFlow.adminId}" />
					</td>
				</tr>
				<tr>
					<td>
						<div align="cer">
							DetailId: <font color="ff0000">*</font>
						</div>
					</td>
					<td>
						<p>
							<input type="text" name="detailId" id="detailId"
								value="${cashFlow.detailId}" />
					</td>
				</tr>
				<tr>
					<td><dilign="center">Detail: <font color="ff0000">*</font>
						</div></td>
					<td>
						<p>
				...
				<tr>
					<td>div align="center">Direction: <font color="ff0000">*</font>
					</div>
					</td>
					<td>
						<p>
