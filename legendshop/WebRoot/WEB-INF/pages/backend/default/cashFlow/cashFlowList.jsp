...
<body>
	<form action="<ls:url address='/admin/cashFlow/query'/>" id="form1"
		method="post">
			...
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="<ls:url address='/admin/cashFlow/query'/>">CashFlow</a></th>
				</tr>
			</thead>
			<tbody>
				<tr>
            	...
            	商城&nbsp;<input type="text" name="userName" maxlength="50"
							...
							<input type="submit" value="搜索" /> <input type="button"
								value="创建CashFlow"
								onclick='window.location="<ls:url address='/admin/cashFlow/load'/>"' />
						</div>
					</td>
				</tr>
			</tbody>
	...
	<div align="center">
		...
		<display:table name="list" requestURI="/admin/cashFlow/query"
			...
			<display:column title="Action" media="html">
				<a href="<ls:url address='/admin/cashFlow/load/${item.flowId}'/>"
					title="修改"> <img alt="修改"
					src="<ls:templateResource item='/common/default/images/grid_edit.png'/>">
				</a>
				<a href='javascript:deleteById("${item.flowId}")' title="删除"> <img
					alt="删除"
