...
<body>
	<form
		action="${pageContext.request.contextPath}/admin/newsCategory/save"
		method="post" id="form1">
		<input id="newsCategoryId" name="newsCategoryId"
			value="${bean.newsCategoryId}" type="hidden">
		<div align="center">
				...
				<thead>
					<tr>
						<th><a href="<ls:url address='/admin/index'/>"
							...
							href="${pageContext.request.contextPath}/admin/newsCategory/query">栏目管理</a>
							&raquo; 创建栏目</th>
					</tr>
				</thead>
			</table>
			<table align="center" class="${tableclass}" id="col1">
				...
				<tr>
					...
					<td><input type="text" name="newsCategoryName"
						id="newsCategoryName" value="${bean.newsCategoryName}" size="50" />
					</td>
				</tr>
				<tr>
					<td>
