		...
		<thead>
			<tr>
				<th><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a>
					&raquo; 商城管理 &raquo; <a
					href="${pageContext.request.contextPath}/admin/userComment/query?status=0">消息管理</a>
					&raquo; 回复用户消息</th>
			</tr>
		</thead>
	</table>
	<table class="${tableclass}" style="width: 100%" id="col1">
		...
		<tr>
			<td width="20%"><div align="right">
					评论内容 <input type="hidden" id="id" value="${comment.id}" name="id" />
				</div></td>
			<td width="80%">${comment.content}</td>
		</tr>
		<tr>
			<td width="20%"><div align="right">
					回复<font color="#ff0000">*</font>
				</div></td>
			<td width="80%"><textarea rows="6" id="answer" name="answer"></textarea>
			</td>
		</tr>
		<tr>
			<td colspan="2">
