...
<body>
	...
	<form action="<ls:url address='/admin/deliveryType/save'/>"
		method="post" id="form1">
		<input id="dvyTypeId" name="dvyTypeId"
			value="${deliveryType.dvyTypeId}" type="hidden">
		<div align="center">
			<table border="0" align="center" class="${tableclass}" id="col1">
				...
				<tr>
					<td>
						<div align="center">
							配送名称: <font color="ff0000">*</font>
						</div>
					</td>
					<td><input type="text" name="name" id="name"
						value="${deliveryType.name}" /></td>
				</tr>
				<tr>
					<td>
						<div align="center">
							默认物流公司: <font color="ff0000">*</font>
						</div>
					</td>
					<td><select id="dvyId" name="dvyId">
							<ls:optionGroup type="select" required="true" cache="fasle"
								beanId="dvyId" beanDisp="name" defaultDisp="-- 物流公司 --"
								hql="select t.dvyId, t.name from DeliveryCorp t where t.userName = ?"
