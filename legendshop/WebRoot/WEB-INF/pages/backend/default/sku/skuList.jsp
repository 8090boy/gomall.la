...
<body>
	<form action="<ls:url address='/admin/sku/query'/>" id="form1"
		method="post">
			...
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="<ls:url address='/admin/sku/query'/>">单品SKU表</a></th>
				</tr>
			</thead>
		</table>
		...
		<input type="submit" value="搜索" /> <input type="button"
			value="创建单品SKU表"
			onclick='window.location="<ls:url address='/admin/sku/load'/>"' /> <br>
	</form>
	<div align="center">
		<%@ include file="/WEB-INF/pages/common/messages.jsp"%>
		<display:table name="list" requestURI="/admin/sku/query" id="item"
			...
			<display:column title="Action" media="html">
				<a href="<ls:url address='/admin/sku/load/${item.skuId}'/>"
					title="修改"> <img alt="修改"
					src="<ls:templateResource item='/img/grid_edit.png'/>">
				</a>
				<a href='javascript:deleteById("${item.skuId}")' title="删除"> <img
