...
<body>
	...
	<form action="<ls:url address='/admin/member/user/roles'/>" id="form1"
		method="post">
			...
			<thead>
				<tr>
					<th><a href="<ls:url address='/admin/index'/>"
						...
						href="<ls:url address='/admin/member/user/query'/>">权限用户管理</a>&raquo;用户[${bean.name }]角色列表
					</th>
				</tr>
			</thead>
		</table>
		...
		<div align="center">
			<input type="button" value="增加角色"
				onclick="window.location='<ls:url address="/admin/member/user/otherRoles/${bean.id}"/>'" />&nbsp;
