...
<script type="text/javascript"
	src="<%=request.getContextPath() %>/plugins/artDialog/artDialog.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath() %>/plugins/artDialog/plugins/iframeTools.js"></script>
<link
	href="<%=request.getContextPath() %>/plugins/artDialog/skins/idialog.css"
...
<body>
	...
	<ul>
		...
		<li>性别:女</li>
		<li>年龄:22</li>
		<li><input type="button" value="测试弹出层" onclick="testPop();" /></li>
