...
<body>
	...
	模版：
	<select class="combox" id="templet" name="templet" requiredTitle="true"
		childNode="cityid" selectedValue="440000"
		retUrl="${pageContext.request.contextPath}/common/loadProvinces">
	</select> 语言：
	<select class="combox" id="language" name="language"
		requiredTitle="true" selectedValue="440300" showNone="false"
		parentValue="440000" childNode="areaid"
		retUrl="${pageContext.request.contextPath}/common/loadCities/{value}">
	</select> 风格：
	<select class="combox" id="style" name="style" requiredTitle="true"
