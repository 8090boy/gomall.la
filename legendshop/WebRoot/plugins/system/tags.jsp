...
<body>
	<table border="1" width="100%">
		...
		<tr>
			...
			<td>支持无参数和有参数两种，根据Locale从对应的文件拿到记录<br>
				支持参数嵌套，例如message:user.name
			</td>
			<td>1.无参数<br>
			<ls:i18n key="user.name" /> <br>
			<br> 2.有参数，动态参数名,start with message: will replace with locale
				message<br> <ls:i18n key="errors.minlength"
					name="message:user.name" length="8" /> <br>
			<br>
			</td>
		</tr>
		<tr>
			<td>地址com.legendshop.core.tag.URLTag（url）</td>
			<td>主动加上前后缀：ContextPath + address</td>
			<td><a href="<ls:url address='/index'/>" target="blank">首页</a></td>
		</tr>
		<tr>
...
/>
			...
			<img
				src="<ls:templateResource item='/common/default/images/addtocart.jpg'/>" />
			</td>
		</tr>
		<tr>
			...
			<td><img
				src="<ls:images item='360buy/hw/KLV-46V530A.jpg'  scale='0' />" />
				<img border="0" alt="" width="780" height="300"
				src="photoserver/photo/360buy/fckeditor/image/haixin32k01z/1314784348093718542.jpg" />
			</td>
		</tr>
		<tr>
			...
			<td>图片定位器，主要针对商品图片资源</td>
			<td><br>
			<img src="<ls:photo item='360buy/hw/KLV-46V530A.jpg'/>" /></td>
		</tr>
		<tr>
