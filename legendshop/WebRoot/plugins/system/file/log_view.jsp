...
<%@page import="com.legendshop.util.FileTimeWrapper"%>
	...
	<center>
		<table width="567" class="tableBorder">
			...
			<tr>
				...
				<td><%=str %></td>
				<td><a
					href="<%=request.getContextPath()%>/servlet/downloadfileservlet/<%=java.net.URLEncoder.encode(fileWrappers[i].getFile().getName(),"UTF-8") %>">下载</a>
				</td>
			</tr>
			<%} }%>
		</table>
