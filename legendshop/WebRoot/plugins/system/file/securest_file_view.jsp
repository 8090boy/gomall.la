...
<body>
	...
	<center>
		<table width="567" class="tableBorder">
			...
			<%
                 	      String filePath = PropertiesUtil.getDownloadFilePath() + "securest/";
			...
			<tr>
				...
				<td><a
					href="<%=request.getContextPath()%>/servlet/downloadfileservlet/securest/<%=java.net.URLEncoder.encode(files[i].getName(),"UTF-8") %>">下载</a>
				</td>
			</tr>
			<%} }%>
		</table>
