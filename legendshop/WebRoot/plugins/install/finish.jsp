...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<table width="98%" align="center" cellpadding="3" cellspacing="0">
			...
			<td width="21%" align="left" valign="top"><table width="162"
					...
					<tr>
						<td width="215" bgcolor="#FFFFFF"><table width="163"
								...
								<tr>
									<td><img src="imgs/select.gif" width="14" height="13"
										align="absmiddle"> 导入数据</td>
								</tr>
								<tr>
									<td><img src="imgs/select.gif" width="14" height="13"
										align="absmiddle"> 安装完成</td>
								</tr>
							</table></td>
					</tr>
				</table></td>
			<td width="79%" align="left" valign="top"><table width="778"
					height="297" cellpadding="3" cellspacing="0">

					<tr>
						<td width="760" height="25"><span class="STYLE3"><img
								src="imgs/p_success.gif" width="36" height="33"
								align="absmiddle">&nbsp;&nbsp;&nbsp;&nbsp;LegendShop安装成功，请重启系统！！</span></td>
					</tr>
					<tr>
						<c:choose>
							<c:when test="${'C2C' == applicationScope.BUSINESS_MODE}">
								<td valign="top" style="line-height: 20px;"><p>
										<br> * <span class="STYLE4">为了确保您网站安全，安装成功后，请把install目录删除</span><br>
										<br> <br>
										<b>LegendShop</b> 默认安装已经带有3个网店<br>
										系统默认商家，访问地址${applicationScope.DOMAIN_NAME}/home, 用户名: home,
										密码: home，<br> 演示商家,
										访问地址${applicationScope.DOMAIN_NAME}/shop/360buy, 用户名: 360buy,
										密码: 360buy<br> <br> 超级管理员帐号：root,密码：root <br>
									</p></td>
							</c:when>
							<c:otherwise>
								<td valign="top" style="line-height: 20px;"><p>
		...
		<tr>
			<td colspan="2" align="center" valign="middle">Power By
				LegendShop ${LEGENDSHOP_VERSION} - All Rights Reserved.</td>
		</tr>
	</table>
</body>
</html>
