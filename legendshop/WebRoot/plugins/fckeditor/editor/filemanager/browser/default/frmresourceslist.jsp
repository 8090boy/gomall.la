...
oListManager.GetFileRowHtml = function( fileName, fileUrl, fileSize )
{
    ...
    return '<tr>' +
            ...
            '<\/td><td>&nbsp;' +
                sLink +
                 '<img  height=\"110px\" width=\"130px\" src="' + ProtectPath( fileUrl ) + '"\/><\/a>&nbsp;&nbsp;&nbsp;&nbsp;' + '&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="deleteFile(\'' + ProtectPath( fileUrl ) + '\');" > 删除 <\/a>' +
    ...
    function rndnum(){
     ...
     function deleteFile(file){
           jQuery.post("${pageContext.request.contextPath}/admin/file/deleteFile", {"filePath" : file}, function(result){
		      if(result == 0){
	              alert("文件删除成功!");
	              Refresh();
	           }else if(result == 1){
