...
public class NewsServiceImpl extends BaseServiceImpl implements NewsService {
	 ...
	 * 
	 * @see
	 * com.legendshop.business.service.NewsService#save(com.legendshop.model
	 * .entity.News)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.legendshop.business.service.NewsService#getDataByCriteriaQuery(com
	...
	public PageSupport getNewsList(HqlQuery hql) {
		PageSupport ps = newsDao.find(hql);
		return ps;
	}
	...
	public PageSupport getNews(String curPageNO, String shopName, Long newsCategoryId) {
		return newsDao.getNews(curPageNO, shopName, newsCategoryId);
	}

	@Override
	public Map<KeyValueEntity, List<News>> getNewsByCategory(String shopName) {
		return newsDao.getNewsByCategory(shopName);
	}
}
