...
public class AdvertisementServiceImpl extends BaseServiceImpl implements AdvertisementService {
	 ...
	 * 
	 * @see
	 * com.legendshop.business.service.AdvertisementService#findAdvertisement
	 * (java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.legendshop.business.service.AdvertisementService#getDataByCriteriaQuery
	 ...
	 * 
	 * @see
	 * com.legendshop.business.service.AdvertisementService#getAdvertisement
	 * (java.lang.String)
	 */
	@Override
	public Map<String, List<Advertisement>> getAdvertisement(String shopName, String page) {
		return advertisementDao.getAdvertisement(shopName, page);
	}
