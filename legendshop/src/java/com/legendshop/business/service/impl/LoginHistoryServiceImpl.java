...
public class LoginHistoryServiceImpl implements LoginHistoryService {
	 ...
	 * 
	 * @see
	 * com.legendshop.business.service.LoginHistoryService#saveLoginHistory(
		...
		if (PropertiesUtil.getObject(SysParameterEnum.LOGIN_LOG_ENABLE, Boolean.class)) {
			...
			try {
				...
				if (log.isDebugEnabled()) {
					log.debug("execute run sql {}, Ip {}, Time {}, UserName {} ", new Object[] { sql, loginHistory.getIp(),
							loginHistory.getTime(), loginHistory.getUserName() });
				}
				jdbcTemplate.update(sql, new Object[] { loginHistory.getIp(), loginHistory.getTime(), loginHistory.getUserName() });
	 ...
	 * 
	 * @see
	 * com.legendshop.business.service.LoginHistoryService#findLoginHistory(
	 ...
	 * @see
	 * com.legendshop.business.service.LoginHistoryService#findLoginHistory(
	 * com.legendshop.core.dao.support.SqlQuery)
	 */
	@Override
