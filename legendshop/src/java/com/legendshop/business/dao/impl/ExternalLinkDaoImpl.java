...
public class ExternalLinkDaoImpl extends BaseDaoImpl implements ExternalLinkDao {
	 ...
	 * 
	 * @see
	 * com.legendshop.business.dao.impl.ExternalLinkDao#getExternalLinkOrderbybs
	 * (java.lang.String)
	 */
	@Override
	...
	public List<ExternalLink> getExternalLink(final String shopName) {
		...
		List list = findByHQL(sql, shopName);
		if (AppUtils.isBlank(list)) {
			list = findByHQL(sql, PropertiesUtil.getDefaultShopName());
		}
		return list;
	}
