...
public interface NewsDao extends BaseDao {
	 ...
	 * @return the news
	 */
	public abstract PageSupport getNews(String curPageNO, String userName, Long newsCategoryId);
	 ...
	 */
	Map<KeyValueEntity, List<News>> getNewsByCategory(String userName);
