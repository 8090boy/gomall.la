...
public interface SubDao extends SubCommonDao {
	 ...
	 */
	public abstract void deleteSub(String userName);
	 ...
	 * @return true, if successful
	 */
	public abstract boolean updateSub(Sub sub, Integer status, String userName, String payTypeId);
	 ...
	 * @return the order
	 */
	public abstract PageSupport getOrder(SimpleSqlQuery query);
