...
public class EnabledUserAction implements UserAction {
	 ...
	 * 
	 * @see
	 * net.fckeditor.requestcycle.UserAction#isCreateFolderEnabled(javax.servlet
	 ...
	 * 
	 * @see
	 * net.fckeditor.requestcycle.UserAction#isEnabledForFileBrowsing(javax.
	 ...
	 * 
	 * @see
	 * net.fckeditor.requestcycle.UserAction#isEnabledForFileUpload(javax.servlet
	 * .http.HttpServletRequest)
	 */
	@Override
