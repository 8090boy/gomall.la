	...
	private void configJavaMailSender() {
		...
		if (changed == null || changed) {
			...
			properties.setProperty("mail.smtp.auth",
					(PropertiesUtil.getObject(SysParameterEnum.MAIL_STMP_AUTH, Boolean.class)).toString());
			properties.setProperty("mail.smtp.timeout", PropertiesUtil.getObject(SysParameterEnum.MAIL_STMP_TIMEOUT, String.class));
			javaMailSender.setJavaMailProperties(properties);
			log.info("Configuration Mail Sender successful Host: {}, Username {}, mail.smtp.auth: {}",
					new Object[] { javaMailSender.getHost(), javaMailSender.getUsername(),
