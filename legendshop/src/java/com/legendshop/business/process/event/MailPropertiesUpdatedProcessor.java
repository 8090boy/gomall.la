...
/**
 * 邮件相关配置更改 The Class MailPropertiesUpdatedProcessor.
 */
public class MailPropertiesUpdatedProcessor extends BaseProcessor<SystemParameter> {
	...
	public void process(SystemParameter systemParameter) {
		log.info("PropertiesUpdater update mail parameter {} , value {}", systemParameter.getName(), systemParameter.getValue());
