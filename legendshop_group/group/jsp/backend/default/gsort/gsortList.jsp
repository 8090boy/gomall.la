...
<%
    ...
    <thead>
    	<tr><th><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 团购管理  &raquo; <a href="${pageContext.request.contextPath}/admin/sort/query">类型管理</a></th></tr>
    </thead>
    <tbody>
    	<tr><td>
  ...
  <div align="center">
    ...
    <display:table name="list" requestURI="/admin/gsort/query" id="item"
      ...
      <auth:auth ifAnyGranted="F_VIEW_ALL_DATA">
	      <display:column title="商城" property="userName" sortable="true" sortName="userName" />
      </auth:auth>
