...
<form action="${pageContext.request.contextPath}/admin/gsort/save" id="sortForm" method="post" enctype="multipart/form-data">
    <table class="${tableclass}" style="width: 100%">
    <thead>
    	<tr><th><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 团购管理  &raquo; <a href="${pageContext.request.contextPath}/admin/gsort/query">类型管理</a> &raquo; 创建商品类型</th></tr>
    </thead>
    </table>
  <table class="${tableclass}" style="width: 100%" id="col1" >
    ...
    <tbody>
    <tr>
      <td width="30%" ><div align="center">类型：<font color="#ff0000">*</font></div></td>
    ...
    <tr>
      ...
      <auth:auth ifAnyGranted="FA_SHOP">
        ...
        <input type="button" value="返回"  onclick='window.location="${pageContext.request.contextPath}/admin/gsort/query"' />  
      </div></td>
    </tr>
    </tbody>
  </table>
